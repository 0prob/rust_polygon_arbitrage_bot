...
const ONE_20: U256 = U256::from_limbs([7766279631452241920, 5, 0, 0]);
const ONE_36: U256 = U256::from_limbs([12919594847110692864, 54210108624275221, 0, 0]);

const MAX_NATURAL_EXPONENT: U256 = U256::from_limbs([15145670503932362752, 7047314121155778, 0, 0]);
...
pub fn log_exp_pow(x: U256, y: U256) -> U256 {
    ...
    if x < ONE_18 {
        let ln_recip = log_exp_ln(ONE_36 / x);
        if ln_recip.is_zero() {
            return U256::ZERO;
        }
...
const EXP_X0: U256 = LN_X0;
const EXP_X1: U256 = LN_X1;
const EXP_A0: U256 = LN_A0;
const EXP_A1: U256 = LN_A1;

const COMMON_EXP_STEPS: [(U256, U256); 8] = [
    (
...
const EXP_STEPS: [(U256, U256); 8] = COMMON_EXP_STEPS;
